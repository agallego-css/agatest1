...
$parentModule = 'agatest1'
if (-not $ModuleName) { $ModuleName = 'agatest1.Client' }
...
$publishRoot = Join-Path -Path $WorkingDirectory -ChildPath 'publish\agatest1'
...
$originalManifestData = Import-PowerShellDataFile -Path "$publishRoot\agatest1.psd1"
$prereqHash = @{
